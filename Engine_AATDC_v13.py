...
if not GOOGLE_GEOCODING_API_KEY:
    raise RuntimeError(
        "Missing GOOGLE_GEOCODING_API_KEY in the .env file."
    )

if not GOOGLE_MAPS_BROWSER_KEY:
    raise RuntimeError(
        "Missing GOOGLE_MAPS_BROWSER_KEY in the .env file."
    )


# FILE PATHS
DATA_DIRECTORY = Path(
    r"C:\Users\wjose\OneDrive\Coding Projects"
    r"\AADTC Map\AATDC_Data_File_Paths"
)

EXCEL_FILE = Path( 
    r"C:\Users\wjose\OneDrive\Coding Projects\AADTC Map\AATDC_Data_File_Paths\States From Excel\AADTC_annualized_statistics_new.xlsx"
)
...
STATE_CONFIGS = {
    "FL": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "Florida" / "Florida.shp"
    },
    "CT": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "Connecticut" / "Connecticut.shp"
    },
    "CO": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "Colorado" / "Colorado.shp"
    },
    "DE": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "Delaware" / "Delaware.shp"
    },
    "DC": {
        "type": "shapefile",
        "shapefile": (
            DATA_DIRECTORY / "District of Columbia" / "District of Columbia.shp"
        )
    },
    "ID": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "Idaho" / "Idaho.shp"
    },
    "IL": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "Illinois" / "Illinois.shp"
    },
    "IN": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "Indiana" / "Indiana.shp"
    },
    "KY": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "Kentucky" / "Kentucky.shp"
    },
    "LA": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "Louisiana" / "Louisiana.shp"
    },
    "ME": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "Maine" / "Maine.shp"
    },
    "MD": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "Maryland" / "Maryland.shp"
    },
    "MI": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "Michigan" / "Michigan.shp"
    },
    "MA": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "Massachusetts" / "Massachusetts.shp"
    },
    "MN": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "Minnesota" / "Minnesota.shp"
    },
    "NH": {
        "type": "shapefile",
        "shapefile": (
            DATA_DIRECTORY / "New Hampshire" / "New Hampshire.shp"
        )
    },
    "NJ": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "New Jersey" / "New Jersey.shp"
    },
    "OH": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "Ohio" / "Ohio.shp"
    },
    "OK": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "Oklahoma" / "Oklahoma.shp"
    },
    "OR": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "Oregon" / "Oregon.shp"
    },
    "PA": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "Pennsylvania" / "Pennsylvania.shp"
    },
    "RI": {
        "type": "shapefile",
        "shapefile": (
    ...
    "VT": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "Vermont" / "Vermont.shp"
    },
    "VA": {
        "type": "shapefile",
        "shapefile": DATA_DIRECTORY / "Virginia" / "Virginia.shp"
    },
